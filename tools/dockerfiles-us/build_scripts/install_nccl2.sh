...
if [ "$VERSION" == "10.0" ]; then
  ...
  if [ -f "/etc/redhat-release" ];then
    ...
    wget --no-check-certificate -q https://developer.download.nvidia.com/compute/machine-learning/repos/rhel8/x86_64/libnccl-2.7.8-1+cuda10.2.x86_64.rpm
    wget --no-check-certificate -q https://developer.download.nvidia.com/compute/machine-learning/repos/rhel8/x86_64/libnccl-devel-2.7.8-1+cuda10.2.x86_64.rpm
    wget --no-check-certificate -q https://developer.download.nvidia.com/compute/machine-learning/repos/rhel8/x86_64/libnccl-static-2.7.8-1+cuda10.2.x86_64.rpm
